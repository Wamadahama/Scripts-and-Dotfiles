# Takes two files and comapres the lines, only counts the ammount of differences in lines
# This was originally used to check the difference between a fiile with \n separated values where one is the answer key
# and one was what a an "ai" came up with
import sys
import math
